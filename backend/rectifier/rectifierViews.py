...
class RectifierView(APIView):

	def get (self, request, *args, **kwargs):
		responseList = []

		queryStatement = "select equipment_category,equipment_type,acronym_asset_name,equipment_type_name from "+config.EQUIPMENT_INFO+" where equipment = 'rectifier' order by acronym_asset_name"
		parameter = []
